...
export class vGLProgram extends TransferrableGLObject implements WebGLProgram {
    public shaders: vGLShader[];
    ...
    detachShader(shader: vGLShader, context: WebGLRenderingContextPolyfill) {
    ...
    link(context: WebGLRenderingContextPolyfill) {
        ...
        for (const shader of this.shaders) {
            ...
            for (let uniform of shader.uniforms) {
            ...
            for (let attribute of shader.attributes) {
