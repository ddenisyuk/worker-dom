import { TransferrableObjectType } from './TransferrableMutation';
...
export class BytesStream {
  ...
  public get internal(): ArrayBuffer {
    if (this._buffer.byteLength - this.offset > 3) {
      console.warn('Buffer allocated more memory than used.', this._buffer.byteLength, this.offset);
    }
  ...
  public constructor(data: number | ArrayBuffer) {
    if (data instanceof ArrayBuffer) {
      this._buffer = data;
      this.maxByteSize = data.byteLength;
    } else {
      this.maxByteSize = data || 1e6;
  ...
  public appendTypedArray(
    ...
    const arrType = BytesStream.arrayTypeToTransferrable[array.constructor.name];
    const type = arrType.type;

    this.appendUint8(type);
    this.appendUint32(array.length);
    const size = arrType.BYTES_PER_ELEMENT;
    this._offset += size - (this._offset % size);
    this.allocate(array.byteLength);

    if (type == TransferrableObjectType.Uint8Array) {
  ...
  public readTypedArray<T extends RelativeIndexable<number>>(type: TransferrableObjectType): RelativeIndexable<number> {
    const arrType = BytesStream.transferrableToArrayType[type];

    const length = this.readUint32();
    this._offset += arrType.BYTES_PER_ELEMENT - (this._offset % arrType.BYTES_PER_ELEMENT);
    const arr = new arrType.constructor(this._buffer, this._offset, length);
    this._offset += arr.byteLength;
    return arr;
  }
  ...
  private static readonly arrayTypeToTransferrable: { [key: string]: { type: number; BYTES_PER_ELEMENT: number } } = {
    Int8Array: { type: TransferrableObjectType.Int8Array, BYTES_PER_ELEMENT: Int8Array.BYTES_PER_ELEMENT },
    Uint8Array: { type: TransferrableObjectType.Uint8Array, BYTES_PER_ELEMENT: Uint8Array.BYTES_PER_ELEMENT },
    Uint8ClampedArray: {
      type: TransferrableObjectType.Uint8ClampedArray,
      BYTES_PER_ELEMENT: Uint8ClampedArray.BYTES_PER_ELEMENT,
    },
    Int16Array: { type: TransferrableObjectType.Int16Array, BYTES_PER_ELEMENT: Int16Array.BYTES_PER_ELEMENT },
    Uint16Array: { type: TransferrableObjectType.Uint16Array, BYTES_PER_ELEMENT: Uint16Array.BYTES_PER_ELEMENT },
    Int32Array: { type: TransferrableObjectType.Int32Array, BYTES_PER_ELEMENT: Int32Array.BYTES_PER_ELEMENT },
    Uint32Array: { type: TransferrableObjectType.Uint32Array, BYTES_PER_ELEMENT: Uint32Array.BYTES_PER_ELEMENT },
    Float32Array: { type: TransferrableObjectType.Float32Array, BYTES_PER_ELEMENT: Float32Array.BYTES_PER_ELEMENT },
    Float64Array: { type: TransferrableObjectType.Float64Array, BYTES_PER_ELEMENT: Float64Array.BYTES_PER_ELEMENT },
  };

  private static readonly transferrableToArrayType: {
    [key: number]: { constructor: any; BYTES_PER_ELEMENT: number };
  } = {
    [TransferrableObjectType.Int8Array]: { constructor: Int8Array, BYTES_PER_ELEMENT: Int8Array.BYTES_PER_ELEMENT },
    [TransferrableObjectType.Uint8Array]: { constructor: Uint8Array, BYTES_PER_ELEMENT: Uint8Array.BYTES_PER_ELEMENT },
    [TransferrableObjectType.Uint8ClampedArray]: {
      constructor: Uint8ClampedArray,
      BYTES_PER_ELEMENT: Uint8ClampedArray.BYTES_PER_ELEMENT,
    },
    [TransferrableObjectType.Int16Array]: { constructor: Int16Array, BYTES_PER_ELEMENT: Int16Array.BYTES_PER_ELEMENT },
    [TransferrableObjectType.Uint16Array]: {
      constructor: Uint16Array,
      BYTES_PER_ELEMENT: Uint16Array.BYTES_PER_ELEMENT,
    },
    [TransferrableObjectType.Int32Array]: { constructor: Int32Array, BYTES_PER_ELEMENT: Int32Array.BYTES_PER_ELEMENT },
    [TransferrableObjectType.Uint32Array]: {
      constructor: Uint32Array,
      BYTES_PER_ELEMENT: Uint32Array.BYTES_PER_ELEMENT,
    },
    [TransferrableObjectType.Float32Array]: {
      constructor: Float32Array,
      BYTES_PER_ELEMENT: Float32Array.BYTES_PER_ELEMENT,
    },
    [TransferrableObjectType.Float64Array]: {
